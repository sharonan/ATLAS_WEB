...
define('ITEM_USER', "https://api.parse.com/1/classes/item_user");
define('EMAIL_ADDRESS', "https://api.parse.com/1/classes/email_address");
...
define('multipleUserObjectTest', "https://api.parse.com/1/functions/multipleUserObjectTest");
define('RESPOND', "https://api.parse.com/1/functions/respond");
define('DELETE_UNVERIFIED_EMAIL_ADDRESSES', "https://api.parse.com/1/functions/deleteUnverifiedEmailAddresses");
