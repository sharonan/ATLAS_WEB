...
$.extend(iCalendar.prototype, {
	...
	//	alert("event"+event);
		...
		$('#icalBtn').click(function() {  
//			if((navigator.userAgent.match(/iPhone/i))||(navigator.userAgent.match(/iPod/i))){
////				window.open( "data:text/calendar;charset=utf8," + escape( event ) );
//				window.location.href = 'https://getatlas.com/reply/ics.php?content=' +event ;
//    		}else
//    	  	window.open( "data:text/calendar;charset=utf8," + escape( event ) );
    	  //	alert(escape( event ));
			window.location.href = 'https://getatlas.com/reply/ics.php?content=' + escape( event ) ;
    	
	});
		$('#outlookBtn').click(function() {  
	    	
	    	
    	  	window.open( "data:text/calendar;charset=utf8," + escape( event ) );
		      
	});
$('#icalBtn1').click(function() {  
...
//    	  	window.open( "data:text/calendar;charset=utf8," + escape( event ) );
	...
	_updateICalendar: function(target, settings) {
		...
		var addSite = function(site, calId) {
			...
			var item = $('<li></li>');
			var anchor = $('<a id="' + settings.tipPrefix + site.display + '" href="' + url + '" title="' + settings.tipPrefix + site.display + '"' +
