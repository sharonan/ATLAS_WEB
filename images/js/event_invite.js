	...
	var calInviteSuccessView = Parse.View.extend({
		...
		initialize: function() {
		      ...
		      render: function() {
			      ...
			      $("#description").attr('class', 'container_sub_header');
	    	    				  	    	    ...
	    	    				  	    	    checkQuery.find({
	    	    				  	    	    	success: function(inviteConfimedCheckup) {
	    	    				  	    		    	...
	    	    				  	    		    	{/// Already responded to the event
		    	  	    	    				  		      ...
		    	  	    	    				  		      location = (location!=null && location!="" && loaction!="undefined")? " at "+location : location;
	    	  	    	    				  		      ...
	    	  	    	    				  		      var eventText = message.split(",")[INVITE_MESSAGE.Title];
	    	  	    	    				  		       location = message.split(",")[INVITE_MESSAGE.Location];
	    	  	    	    				  		      eventText += (location !=null && location!="" && location!="undefined")? " at "+location : "";
