...
//	    	    				  				success: function(reciever) {
	    	    				  				...
	    	    				  				//	var reciever = reciever.get("displayname");
	    	    				  					...
	    	    				  					var date = messageTask.split(",")[TASK_MESSAGE.Date];
		    	    				  	    	    	...
		    	    				  	    	    	success: function(inviteConfimedCheckup) {
		    	    				  	    		    	...
		    	    				  	    		    	{/// Already responded to the event
		    	    				  							...
		    	    				  							$("#acceptRejectTitle").css('visibility','hidden');
	    				  	    	     						...
	    				  	    	     						var pastRespond = inviteConfimedCheckup[0].get("accept")? "confirmed" : "declined";
	    				  	    	     						jAlert(senderName+ ' Has been informed, you '+ pastRespond+' his task',reciever, function(r) {
...
//		    				  	    	     						$("#taskTitle").html(messageTitle+" "+messageContent).show();
		    				  	    	     						window.location = "http://flurydesign.com/websites/atlas/consumer/";	
		    	    				  	    	    		...
		    	    				  	    	    		if (inviteConfimedCheckup[0] == null || !inviteConfimedCheckup[0].get("isRead"))
		    	    				  	    	    		{
...
//	    	    				  	
		    	    				  	    	    			...
		    	    				  	    	    			$("#confirm_task").click(function () {
		    	    				  	    	    			  ...
		    	    				  	    	    			  task.save(null, {
	  		    	    				  	    	    			...
	  		    	    				  	    	    			taskAcceptNew.set("isRead",false);
...
//	  		    	    				  	    	    				$("#confirm_task").css('visibility','hidden');	
		    	    				  	    	    		...
		    	    				  	    	    		else/// Inviter already read the respond
		    	    				  	    	    			{
		    				  	    	     						window.location = "http://flurydesign.com/websites/atlas/consumer/";	
