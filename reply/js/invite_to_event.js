$(function() {
  ...
  var WEEK_DAY = {0:"Sunday",1:"Monday",2:"Tuesday",3:"Wednesday",4:"Thursday",5:"Friday",6:"Saturday"};
	...
	var respond = "";
  sendMessageBack = function(accept, message, invite, inviterId, inviteeName)
  {
...
//  	  						   message.split(",")[INVITE_MESSAGE.Location];
  ...
  //	  eventAcceptNew.set("message",messageAcceptBack);
  	  eventAcceptNew.set("inviteeName",inviteeName);
  	...
  	eventAcceptNew.set("isRead",false);
  	eventAcceptNew.set("event_duration", duration);
  	  ...
  	  eventAcceptNew.save(null, {
  		  success: function(eventRespond) {
  			...
  			invite.set("isRead",true);
  			invite.save(null, {
  	  		  success: function(eventRespond) {
  	  			  
  	  			   respond = (accept)? "confirmed":"declined";
  	  			  
  	  			  //Responder's Name has confirmed "Event Title" at time on day. 
  	  			  //Responder's Name has declined "Event Title"
  	  			  	var message = inviteeName+" has "+respond+ "  "+title;
  	  			 
  	  			  	message += (accept)? " at "+finalDate:" ";
					Parse.Push.send({
						//	where: pushQuery,
							 channels:["ID"+inviterId],
						  data: {
						    alert: message,
		...
		initialize: function() {
		      ...
		      render: function() {
			      ...
			      $("#appointment").attr('class', 'appointment');
		  		  ...
		  		  var successString = invitee_name+" "+respond+", Your appointment for "+eventDetails;
...
//	    	    				  			success: function(invitee) {
	    	    				  				...
	    	    				  				var senderPic = inviter.get("picture").url.toString();
	    										...
	    										$("#avatar").attr('src', senderPic);
	    	    				  				...
	    	    				  				invitee_name = message.split(",")[INVITE_MESSAGE.toDisplayName];
	    	    				  				invitee_name = (invitee_name==null)? "":invitee_name;
	    	  	    	    				  		 		...
	    	  	    	    				  		 		if (date2!=null && date2!="" && date2!="undefined")
	    	  	 	    	    				  		   {
	    	  	    	    				  		 		...
	    	  	    	    				  		 		var date3 =  message.split(",")[INVITE_MESSAGE.AlternativeDate2];
	    	  	    	    				  			      ...
	    	  	    	    				  			      $("#confirmEvent").click(function() {  
	    	  	    	    				  			    	...
	    	  	    	    				  			    	sendMessageBack(true,message, invite,inviterId,invitee_name);
	    	  	    	    				  			      ...
	    	  	    	    				  			      $("#decline").click(function() {
	    	  		    	    				  			    	sendMessageBack(false,message, invite,inviterId,invitee_name);
